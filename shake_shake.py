...
class ShakeResNet(nn.Module):
    def __init__(self, block=ShakeBlock, num_classes=10):
        ...
        self.stage1 = self._make_stage(block, 24, 4, stride=1)
        self.stage2 = self._make_stage(block, 48, 4, stride=2) 
        self.stage3 = self._make_stage(block, 96, 4, stride=2)  
